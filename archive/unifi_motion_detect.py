...
logname = '/playground/unifi-video/logs/object_detected.log'
...
data=json.loads(open('/playground/Smart-Motion-Detector/keys.json').read())

# Load Camera UUIDs from file:
with open('/playground/Smart-Motion-Detector/support_dbdevices.json') as f:
...
LOG_FILE = '/playground/unifi-video/logs/recording.log'
    ...
    try:
        ...
        for i in tail(LOG_FILE, 1):
            if WATCH_FOR.lower() in i.lower():
                ...
                for root, directories, filenames in os.walk('/playground/unifi-video/videos/'+ cameras[camera_name_id[1]] + '/' + date_path):
                            ...
                            if image is not None:
                                try:
                                    ...
                                    if boxes != boxes_last:
                                        ...
                                        boxed_img_path = '/playground/unifi-video/object_detections/'+ str(start) +'_'+ str(camera_name_id[1]) +'_'+ str(recording_id) + '.jpg' 
